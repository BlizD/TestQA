...
Сценарий: Подготовка данных
	...
	Сценарий: Добавление штрихкода
	И я закрываю все окна клиентского приложения
	И Я запоминаю в переменную "ШтрихКод" значение "1234567890"	
	...
	* Очистка старого ШК если он был создан уже
		Если таблица "List" стала равной: Тогда
			...
			| 'Barcode'    | 'Item serial/lot number' | 'Unit' |
			| '$ШтрихКод$' | ''                       | 'шт'   |		
			И в таблице "List" я нажимаю на кнопку с именем 'ListContextMenuDelete'
			Тогда открылось окно '1C:Enterprise'
			И я нажимаю на кнопку с именем 'Button0'
	* Добавление нового ШК
		...
		И в поле с именем 'Presentation' я ввожу текст 'Тест ШК'
